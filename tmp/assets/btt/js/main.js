...
; browserify_shim__define__module__export__(typeof mCustomScrollbar != "undefined" ? mCustomScrollbar : window.mCustomScrollbar);
...
var _mCustomScrollbar = require('mCustomScrollbar');

var _mCustomScrollbar2 = _interopRequireDefault(_mCustomScrollbar);
...
$.fn.materialize = function () {
    return this.each(function () {
        ...
        $this.before($label).before($arrow).on('change', function (e) {
        ...
        $this.parent().on('click', '.material-label', function () {
            ...
            $window.on('resize scroll', (0, _helper.debounce)(listener, 250));
            ...
            $materialSelectWrapper.find('select').val(selectedValue).trigger('change').end().find('.material-label').text($this.text());
        ...
        $body.on('click', function (e) {
            ...
            if (!$eTarget.hasClass('material-select-wrapper') && !$eTarget.parents('.material-select-wrapper').length) {
                ...
                $window.off('resize scroll', (0, _helper.debounce)(listener, 250));
            }
        });
...
$(function () {
    ...
    $('.floating-input').each(function () {
        ...
        $this.wrap('<div class="floating"></div>').before('<span class="placeholder">' + $this.attr('placeholder') + '</span>').attr('placeholder', '').on('focus', function () {
            var $this = $(this);
    ...
    if ($card.length) {
        $card.each(function (i, el) {
            ...
            var cardWatcher = _scrollMonitor2.default.create(el);
        ...
        _scrollMonitor2.default.recalculateLocations();
    }

    $window.on('resize', (0, _helper.debounce)(function () {
...
///////////////////
var inc = 0;
var ripple = function ripple(e, el) {
...
var _primaryNav = require('../../../_modules/primary-nav/primary-nav');
...
(0, _jquery2.default)(function () {
    new _primaryNav2.default(); // Activate Primary NAv modules logic
    ...
    // Init Lazy Loading //
    ///////////////////////
    (0, _jquery2.default)('.lazy').lazyload({
        effect: 'fadeIn'
    });
    ...
    /////////////////////////////
    (function () {
        var $inputText = (0, _jquery2.default)('input[type="text"]');

        if ((0, _jquery2.default)('.no-placeholder').length) {
    ...
    ////////////////////////////////////
    (function () {
        if ((0, _jquery2.default)('.no-bgsizecover').length) {
            (0, _jquery2.default)('.backstretch').each(function () {
                var $this = (0, _jquery2.default)(this),
    ...
    ////////////////////////////
    (function () {
        _jquery2.default.fn.isTableWide = function () {
            return (0, _jquery2.default)(this).parent().width() < this.width();
        };
        ...
        (0, _jquery2.default)('table').each(function () {
            ...
            if ($this.length && !$this.parent().hasClass('table-wrapper') && $this.isTableWide()) {
                $this.after('<button class="btn-print-table js-print-table">View Table</button>').wrap('<div class="table-wrapper"></div>');
            }
        });

        var $tablePreview = (0, _jquery2.default)('.table-preview');
        if ($tablePreview.length) {
            (0, _jquery2.default)('meta[name="viewport"]').attr('content', 'user-scalable=yes');
        ...
        (0, _jquery2.default)('body').on('click', '.js-print-table', function () {
            var $table = (0, _jquery2.default)(this).prev();
    ...
    /////////////////////
    (function () {
        $window.on('resize scroll', (0, _helper.debounce)(toggleHeader, 250));
...
var _material = require('../../_assets/btt/js/_material');

var _helper = require('../../_assets/btt/js/_helper');
...
var PrimaryNav = function PrimaryNav() {
    ...
    $primaryNav.on('click', function (e) {
        ...
        if ($this.hasClass('active')) {
            ...
            $set.removeClass('active').find('.icon-arrow.active').removeClass('active');
    ...
    $subNav.on('touchend, click', function () {
        ...
        if ($this.hasClass('active')) {
            if ($next.hasClass('lvl2')) {
                ...
                $this.removeClass('active').next().find('.icon-arrow.active').removeClass('active');
            ...
            if ($grandParent.hasClass('lvl1')) {
                $lvl1.find('.icon-arrow.active').removeClass('active').next().removeClass('active').slideUp({
                    duration: 500,
                    easing: 'easeOutExpo'
                });
            } else if ($grandParent.hasClass('lvl2')) {
                $lvl2.find('.icon-arrow.active').removeClass('active').next().removeClass('active').slideUp({
                    duration: 500,
                    easing: 'easeOutExpo'
                });
            }
    ...
    $window.on('scroll', (0, _helper.debounce)(function () {
        isMobileDevice = $window.width() < 1024 ? true : false;
