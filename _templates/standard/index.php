...
<main id="main">
    ...
    <!-- Hero Banner -->
    <header class="standard-banner backstretch lazy" data-original="/assets/btt/images/background.jpg">
        <div class="container">
        ...
        <div class="wrap">
            <article class="col-12">
                ...
                <table width="631">
                    <thead>
                        <tr>
                            <th colspan="2" width="210">Lorem ipsum dolor</th>
                            <th colspan="2" width="210">Consectetur adipiscing elit</th>
                            <th colspan="2" width="210">Curabitur laoreet</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td width="105">
                                <p>Cras pulvinar magna</p>
                            </td>
                            <td width="105">
                                <p>Massa commodo</p>
                            </td>
                            <td width="105">
                                <p>Nulla ut felis gravida</p>
                            </td>
                            <td width="105">
                                <p>Fusce ac massa bibendum</p>
                            </td>
                            <td width="105">
                                <p>Quisque at risus at</p>
                            </td>
                            <td width="105">
                                <p>Donec non sapien</p>
                            </td>
                        </tr>
                        <tr>
                            <td width="105">
                ...
                <h3>Sample Financial Table</h3>
                <table>
                    <thead>
                        <tr>
                            <th colspan="21">Table C-4 Present Value Interest Factors for $1 Annuity Discounted at i Percent for n Periods: PVA = PMT  PVIFA<sub>i,n</sub></th>
                        </tr>
                        <tr>
                            <th>Period</th>
                            <th>1%</th>
